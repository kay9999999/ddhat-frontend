...
import { getDatabaseData } from "@/data/loaders";
import { getStrapiURL } from "@/lib/utils";
import { MdPlayArrow } from "react-icons/md";

export async function generateMetadata() {
  try {
    const responseData = await getDatabaseData();
    ...
    return {
      title: " Database Systems", // Fallback title
    };
  }
}
  ...
  return (
    <div className="text-gray-900">
      ...
      <section className="py-8 px-6 text-center">
        <h2 className="lg:text-4xl md:text-2xl font-semibold mb-14">
          {data.cardheading}
          <span className="block mt-2 h-[3px] w-1/2 mx-auto bg-gradient-to-r from-cyan-700 via-blue-500 to-indigo-600"></span>
        </h2>
